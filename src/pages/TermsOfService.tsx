  ...
  return (
    <div className="pt-32 pb-20 max-w-4xl mx-auto px-6">
      <Helmet>
        ...
        <meta name="description" content="Review the Terms of Service for MrGardenr. Understand the rules, guidelines, and agreements for using our landscaping services and website." />
        <meta name="keywords" content="terms of service, terms and conditions, user agreement, mrgardenr terms" />
      </Helmet>
