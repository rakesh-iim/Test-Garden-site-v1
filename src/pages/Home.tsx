        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/contact#book" className="relative overflow-hidden group bg-primary-container text-on-primary font-bold px-8 py-4 rounded-full flex items-center gap-3 w-fit shadow-lg border border-transparent transition-transform duration-300 hover:shadow-2xl hover:scale-[1.03] hover:-translate-y-1">
              ...
              <span className="relative z-10 group-hover:text-primary-container transition-colors duration-500">Get a Free Quote</span>
              <ArrowRight className="w-5 h-5 relative z-10 group-hover:text-primary-container transition-colors duration-500" />
            </Link>
            <Link to="/gallery" className="relative overflow-hidden group border-2 border-secondary text-secondary font-bold px-8 py-4 rounded-full transition-transform duration-300 hover:shadow-xl hover:scale-[1.03] hover:-translate-y-1 w-fit text-center">
              <span className="absolute inset-0 w-full h-full bg-secondary origin-top-right group-hover:origin-bottom-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.86,0,0.07,1)] z-0"></span>
              <span className="relative z-10 group-hover:text-surface transition-colors duration-500">View Gallery</span>
            </Link>
          </div>
        </motion.div>
      </div>
