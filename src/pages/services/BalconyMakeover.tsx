...
import { ArrowRight, ArrowLeft, CheckCircle2, ChevronRight, Leaf, Maximize, Sun, Shield, Droplets } from 'lucide-react';
...
export const BalconyMakeover = () => {
  ...
  const process = [
    { step: "Consultation & Assessment", desc: "We evaluate spatial constraints, wind exposure, and lighting to form a baseline." },
    { step: "3D Spatial Design", desc: "Creating vertical-first layouts with multifunctional furniture and layered planting." },
    { step: "Material Curation", desc: "Selecting ultra-lightweight soils, durable containers, and resilient flora." },
    { step: "Rapid Installation", desc: "Clean, efficient transformation usually completed in a single day." }
  ];
    ...
    <div className="bg-surface relative overflow-hidden">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-end pb-24 overflow-hidden bg-black">
        <motion.div style={{ y: y1 }} className="absolute inset-0 z-0 opacity-80">
          <img src="/images/service-balcony.webp" alt="Luxury balcony garden" className="w-full h-full object-cover" />
      ...
      <section className="py-24 relative z-10 bg-surface">
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            >
              <img src="/images/project-1.webp" alt="Detailed balcony greenery" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center flex-col-reverse lg:flex-row-reverse mb-24">
            ...
            <motion.div 
              ...
              className="relative aspect-square md:aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-2xl"
            >
              <img src="/images/project-3.webp" alt="Urban balcony engineering" className="w-full h-full object-cover" />
      ...
      <section className="py-24 relative overflow-hidden bg-surface">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-secondary/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
              ...
              {process.map((step, idx) => (
                ...
                >
                  ...
                  <div className={`w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-8 rounded-[2rem] bg-surface-container-lowest shadow-md border border-black/5 dark:border-white/5 relative overflow-hidden ml-6 md:ml-0 group-hover:shadow-xl group-hover:-translate-y-1 transition-all duration-300 ${idx % 2 === 0 ? 'md:mr-auto' : 'md:ml-auto'}`}>
                    <div className="absolute -right-4 -bottom-4 text-8xl font-display font-black text-black/5 dark:text-white/5 group-hover:text-primary/5 transition-colors duration-500">
                      0{idx + 1}
                    </div>
