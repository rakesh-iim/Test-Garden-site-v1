    ...
    <div className="bg-surface relative overflow-hidden">
      ...
      <section className="py-20 relative overflow-hidden bg-surface">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/images/service-balcony.webp')` }}
        />
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-secondary/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
        ...
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 xl:px-24 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-gradient-to-b before:from-primary/5 before:via-primary/20 before:to-primary/5">
              {process.map((step, idx) => (
                ...
                >
                  ...
                  <div className={`w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 rounded-[2rem] bg-surface-container-lowest shadow-md border border-black/5 dark:border-white/5 relative overflow-hidden ml-6 md:ml-0 group-hover:shadow-xl group-hover:-translate-y-1 transition-all duration-300 ${idx % 2 === 0 ? 'md:mr-auto' : 'md:ml-auto'}`}>
                    <div className="absolute -right-4 -bottom-4 text-6xl font-display font-black text-black/5 dark:text-white/5 group-hover:text-primary/5 transition-colors duration-500">
                      0{idx + 1}
                    </div>
