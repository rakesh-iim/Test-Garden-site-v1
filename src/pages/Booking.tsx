  ...
  return (
    <div className="pt-20 bg-surface">
      ...
      <div className="min-h-[calc(100vh-80px)] py-12 lg:py-24 relative overflow-hidden">
        ...
        <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-secondary/10 rounded-full blur-[60px] pointer-events-none"></div>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
               ...
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-primary/10 to-secondary/10 blur-[50px] rounded-full -z-10"></div>
