  ...
  <footer className="bg-surface-container-highest/95 backdrop-blur-md py-4 md:py-6 px-6 border-t border-black/5 shadow-[0_-4px_25px_rgba(0,0,0,0.1)]">
    <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 xl:px-24 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <Link to="/contact" className="relative overflow-hidden group flex items-center gap-2 bg-primary-container text-on-primary px-5 py-2.5 rounded-full font-bold text-sm hover:scale-[1.03] hover:-translate-y-0.5 hover:shadow-lg transition-transform duration-300 shadow-sm">
          ...
          <Phone size={16} className="relative z-10 group-hover:text-primary-container transition-colors duration-[0.5s]" />
          <span className="hidden sm:inline relative z-10 group-hover:text-primary-container transition-colors duration-[0.5s]">Contact Us</span>
        </Link>
      </div>
    </div>
  </footer>
