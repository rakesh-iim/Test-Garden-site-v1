    ...
    <nav className="fixed top-0 w-full z-50 bg-surface/90 backdrop-blur-md shadow-sm">
      <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 xl:px-24 h-14 sm:h-16 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-8 items-center">
          ...
          <Link to="/contact#book" className="relative overflow-hidden group bg-primary-container text-on-primary px-6 py-2.5 rounded-full font-semibold text-sm text-center shadow-sm transition-transform duration-300 hover:shadow-lg hover:scale-[1.03] hover:-translate-y-0.5 my-auto">
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <Link to="/contact#book" onClick={() => setIsOpen(false)} className="relative overflow-hidden group bg-primary-container text-on-primary px-6 py-3 rounded-full font-semibold mt-2 text-center text-base block shadow-sm transition-transform duration-300 hover:shadow-lg hover:scale-[1.03] hover:-translate-y-0.5">
                <span className="absolute inset-0 w-full h-full bg-white origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-[0.5s] ease-[cubic-bezier(0.8,0,0.2,1)] z-0"></span>
                <span className="relative z-10 group-hover:text-primary-container transition-colors duration-[0.5s]">Book a Visit</span>
              </Link>
            </div>
